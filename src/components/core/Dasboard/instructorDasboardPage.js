...
import { getInstructorDeshboard } from "../../../services/operations/Profile"
...
export default function Instructor() {
  ...
  useEffect(() => {
    ;(async () => {
      setLoading(true)
      const instructorApiData = await getInstructorDeshboard(token)
                  ...
                  <div className="mt-3 w-full">
                    ...
                    <div className="mt-1 flex items-center space-x-2">
                      <p className="text-xs font-medium text-richblack-300">
                        {course.totalEnrolledStudent} students
                      </p>
                      <p className="text-xs font-medium text-richblack-300">
                        |
                      </p>
